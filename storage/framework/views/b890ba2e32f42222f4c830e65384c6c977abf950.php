<div class="form-group">
    ...
    <?php echo Form::select('id_siswa', App\Siswa::pluck('nama','id')->all()->$penilaian->siswa->nama,['class' =>$errors->has('id_siswa') ? 'form-control is-invalid' : 'form-control','required' ]); ?>
